...
joined_data <- data %>%
  ...
  #select(-c(`1999`)) |> 
  filter(!Reitur %in% c("R51", "R1", "R2", "R4", "R5", "R6", "R9", "R10", "R15", "R28", "R29", "R53", "R54", "R55", "R57", "R58", "R59", "R61", "R62")) |> 
...
for (i in unique(joined_data$Stadur)[5]) {
